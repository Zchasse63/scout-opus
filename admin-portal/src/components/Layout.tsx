...
export default function Layout() {
  ...
  const navigation = [
    ...
    { name: 'Partner Approvals', href: '/partners', icon: Building2 },
    { name: 'Support Tickets', href: '/tickets', icon: MessageCircle },
        ...
        <div className="flex min-h-0 flex-1 flex-col border-r border-gray-200 bg-white">
          <div className="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
            <div className="flex flex-shrink-0 items-center px-4">
              <h1 className="text-2xl font-bold text-indigo-600">Scout Admin</h1>
            </div>
      ...
      <div className="sticky top-0 z-10 flex h-16 flex-shrink-0 bg-white shadow md:hidden">
        ...
        <div className="flex flex-1 justify-between px-4">
          <div className="flex flex-1 items-center">
            <h1 className="text-xl font-bold text-indigo-600">Scout Admin</h1>
          </div>
